...
\blueBox{Propiedades - valor absoluto}{
    ...
    \begin{itemize}
        ...
        \item[3.] $|a| = |-a|$
        \item[4.] $|a| \leq k \; \text{equivale a} \; -k \leq a \; \leq k$
        \item[5.] $|a| \geq k \; \text{equivale a} \; a \leq -k \; \text{o bien} \; k \leq a$
        \item[6.] $|a+b| \leq |a| + |b|$ (desiguldad triangular)
    \end{itemize}
}
...
\blueBox{Propiedades - Potenciación}{
    ...
    \begin{itemize}
        \item[1.]{$a^m \cdot a^n = a^{m+n}$  (Producto de potencias de igual base)}
        \item[2.] {$\text{\Large $\frac{a^m}{a^n}$} = a^{m-n}$ (Cociente d epotencias de igual base ($a \neq 0$))} 
        \item[3.] {$(a^m)^n = a^{m \cdot n}$ (Potencia de potencia)}
        \item[4.] {$(a \cdot b)^n = a^n \cdot b^n$ (La potenciación es distributiva respecto de la multiplicación)}
        \item[5.] {$\text{\Large $\bigl(\frac{a}{b} \bigr)$}^n = \text{\Large $\frac{a^n}{b^n}$} \; \; b \neq 0$ (La potenciación es distributiva respecto de la división)}
    \end{itemize}
}
...
\blueBox{Propiedades - radicación}{
    \begin{itemize}
        \item [1.] $\sqrt[n]{a \cdot b} = \sqrt[n]{a} \cdot \sqrt[n]{b}$ (a y b deben ser no negativos en el caso n par)
        \item [2.] $\text{\Large $\sqrt[n]{\frac{a}{b}}$} = \text{\Large $\frac{\sqrt[n]{a}}{\sqrt[n]{b}}$}$ (a y b deben ser no negativos en el caso n par, además b debe ser, en cualquier caso, distinto de 0)
        \item [3.] $\sqrt[n]{\sqrt[m]{a}} = \sqrt[n \cdot m]{a}$ (a debe ser no negativo si n o m fuesen pares)
    \end{itemize} 
}
...
\blueBox{Propiedades}{
    \begin{itemize}
        \item [1.] (Desigualdad triangular) La suma de los dos lados menores de un triángulo es mayor que el lado mayor.
        $$\overline{AB} + \overline{BC} > \overline{AC}$$
        \item[2.] En todo tríangulo, a mayor lado se opone mayor ángulo
    \end{itemize}
}
...
\blueBox{Propiedades de los paralelogramos}{
    \begin{itemize}
        \item [1.] Los lados opuestos de un paralelogramo son congruentes
        \item [2.] Los ángulos opuestos de un paralelogramo son congruentes
        \item [3.] las diagoales de un paralelogramo se cortan en sus puntos medios.
    \end{itemize}
}
$$\boxed{A = B \cdot h}$$
\begin{center}
...
\blueBox{Propiedades del rombo}{
    \begin{itemize}
        \item [1.] Las diagonales del rombo son perpendiculares entre sí (forman ángulos rectos)
        \item [2.] Las diagonales del rombo son bisectrices de los ángulos que unen
    \end{itemize}
}
